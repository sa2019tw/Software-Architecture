package com.example.sa_hw.HW2Domain;

public class HW2Course {
    ...
    public HW2Course(String name, String introduction, String suitable, int price, String notice, String remark){
        setCourseName(name);
