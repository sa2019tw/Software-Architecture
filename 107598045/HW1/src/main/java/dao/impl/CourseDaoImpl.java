...
public class CourseDaoImpl implements CourseDao {
    ...
    public int getMaxCourseId() throws SQLException {
        String sql = "SELECT MAX(courseId) FROM course_purpose";
    ...
    public List<Course> getCourseList() throws SQLException {
        String sql = "SELECT * FROM course_purpose ORDER BY courseId";
    ...
    public void deleteCourseToDB(int courseId) throws SQLException {
        String sql = "DELETE FROM course_purpose WHERE courseId = ?";
        PreparedStatement preparedStatement = null;
        try{
            preparedStatement = pcon.prepareStatement(sql);
    ...
    public Course findTheCourse(int courseId) throws SQLException {
        String sql = "SELECT * FROM course_purpose WHERE courseId = ?";
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
    ...
    public void editCourseToDB(Course course) throws SQLException {
        String sql = "UPDATE course_purpose SET courseName = ?, courseDetail = ?, courseSuitPeople = ?, coursePrice = ?, courseNotes = ?, courseRemark = ? WHERE courseId = ?";
        PreparedStatement preparedStatement = null;
        int i = 1;
        try {
            preparedStatement = pcon.prepareStatement(sql);
