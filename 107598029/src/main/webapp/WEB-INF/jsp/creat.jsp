    ...
    <form action="/creat" method="post">
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="number" class="form-control" name="courseprice" id="courseprice" placeholder="Price">
            </div>

            <div class="form-group col-md-6">
                <label for="coursedescription">課程說明</label>
                <input type="text" class="form-control" name="coursedescription" id="coursedescription" placeholder="Description">
            </div>
            <div class="form-group col-md-6">
                <label for="precautions">注意事項</label>
                <input type="text" class="form-control" name="precautions" id="precautions" placeholder="Description">
            </div>
